...
Mat RenderFrame(void)
{
	...
	auto pAreaLightSampler = std::make_shared<CSamplerStratified>(2);
	...
	// --- Problem 3 ---
	auto pGlossinessSampler = std::make_shared<CSamplerStratified>(2);
	pShaderFloor = std::make_shared<CShaderGlossy>(scene, Vec3f::all(1), 0.1f, 0.9f, 0.0f, 40.0f, 0.0f, pGlossinessSampler);
	// --- ------- - ---
